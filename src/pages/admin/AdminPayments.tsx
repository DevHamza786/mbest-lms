          ...
          {isLoadingPayment ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label className="text-sm font-medium text-muted-foreground">Package plan</Label>
              ...
              {selectedPayment.package && (
                <div>
                  <Label className="text-sm font-medium text-muted-foreground mb-2 block">Package plan Details</Label>
          ...
          <div className="space-y-4">
            {selectedPayment && (
              <div className="bg-muted p-4 rounded">
                ...
                <p><strong>Package plan:</strong> {selectedPayment.package?.name}</p>
