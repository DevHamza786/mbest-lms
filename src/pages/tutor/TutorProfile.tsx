...
export default function TutorProfile() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    bio: 'Experienced educator passionate about helping students achieve their academic goals.',
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Get notified about student progress and submissions
                    </p>
                  </div>
                  <Switch
                    checked={preferences.studentUpdates}
                    onCheckedChange={(checked) => setPreferences(prev => ({ ...prev, studentUpdates: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setPreferences(prev => ({ ...prev, classReminders: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Alerts when grades need to be submitted
                    </p>
                  </div>
                  <Switch
                    checked={preferences.gradeSubmissions}
                    onCheckedChange={(checked) => setPreferences(prev => ({ ...prev, gradeSubmissions: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setPreferences(prev => ({ ...prev, messageAlerts: checked }))}
                  />
                </div>
              </div>
            </CardContent>
